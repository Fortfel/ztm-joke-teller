// VoiceRSS Javascript SDK (a little modified - added frt_audio parameter)
export const VoiceRSS = {
  speech: function(e, frt_audio) {this._validate(e), this._request(e, frt_audio)}, _validate: function(e) {
